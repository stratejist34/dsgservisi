...
serviceName: "DSG Kavrama Değişimi"
...
- İlk kalkışta titreme, düşük devirde sarsıntı
- R/düşük viteslerde silkeleme (tutuş noktası kaybı)
- Yokuşta geri kaçırma, kavrama kokusu (aşırı ısınma)
- Vites yükseltirken boşa düşme hissi (kavrama kayması)
- Volant kaynaklı tıkırtı sesleri (çift kütleli volant yay/yatak hasarı)
- Arıza lambası ve emniyet modu
- OBD’de kavrama/adaptasyon hataları (P17XX)
- Rampa/ağır yükte güç kaybı

## DSG Kavrama Değişimi Süreci

1. Ön kontrol ve test sürüşü: soğuk/sıcak koşullarda davranış analizi  
2. Arıza kodları ve adaptasyon değerleri: aşınma oranı/pozisyon  
3. Söküm, kavrama seti ve volant kontrolü: disk kalınlığı, yüzey/tolerans  
4. Kavrama seti değişimi: DQ200 (kuru), DQ250/DQ381 (ıslak)  
5. Gerekirse volant değişimi: üretici tork değerlerine uygun montaj  
6. Yağ/filtre ve spesifikasyon doğrulaması  
...
| Özellik | Kuru Kavrama (DQ200) | Islak Kavrama (DQ250/DQ381) |
| --- | --- | --- |
| Kullanım | Düşük‑orta tork motorlar | Yüksek tork motorlar |
| Soğutma | Hava soğutmalı | Yağ soğutmalı |
| Ömür | 60.000–100.000 km | 100.000–150.000 km |
| Fiyat | Daha uygun | Daha yüksek |
| Isınma Toleransı | Düşük (şehir içi riskli) | Yüksek |

## Bakım Önerileri

<div class="note">
<ul>
<li>Agresif kalkış ve ani gaz‑fren geçişlerinden kaçının.</li>
<li>Rampa beklemelerinde fren tutarak kavramayı yakmayın.</li>
<li>Düzenli yağ değişimi, hidrolik sistemi korur ve ömrü uzatır.</li>
<li>Soğukta nazik kullanım; ilk 2–3 km yüksek devirden kaçının.</li>
</ul>
</div>

## Marka ve Model Bazında Kavrama Değişimi

**Volkswagen:** Golf, Polo, Passat, Jetta, Tiguan – DQ200 (kuru) ve DQ250 (ıslak)  
**Audi:** A3, A4, A5, Q3, Q5 – S‑tronic kavrama; performans motorlarda ısınma kontrolü  
