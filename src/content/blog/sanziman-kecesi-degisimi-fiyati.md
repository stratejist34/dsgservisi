...
**UZMAN TAVSİYESİ:** "Keçe değişimi yapıldı ama hala kaçak var" durumlarında, kaçak kaynağı yanlış tespit edilmiş olabilir. UV ışık testi ve basınç testi ile kaçak kaynağı doğru belirlenmeli, gereksiz parça değişimi önlenmelidir. Erken teşhis, maliyeti %60 azaltır.
...
## Şanzıman Keçesi Nedir ve Neden Değişir?

Şanzıman keçesi, şanzıman mili ve gövde arasındaki sızdırmazlığı sağlayan kauçuk veya silikon malzemeden yapılmış bir bileşendir. Keçe; yağın dışarı sızmasını önlerken, toz ve suyun şanzıman içine girmesini de engeller.

### Keçe Değişim Nedenleri

- **Yaşlanma ve aşınma:** 100.000–150.000 km sonrası keçe elastikiyetini kaybeder
- **Termal stres:** Aşırı ısınma keçe malzemesini sertleştirir ve çatlatır
- **Kimyasal bozulma:** Yağ kalitesi düşükse keçe malzemesi bozulur
...
- Fiyatlar şanzıman tipi, model ve keçe tipine göre değişir
- DSG şanzımanlarda mekatronik modül keçesi değişimi daha maliyetlidir
- 4x4 sistemlerde diferansiyel keçesi değişimi ek maliyet getirir
- Orijinal keçe kullanımı daha pahalıdır ancak uzun ömürlüdür
...
## Şanzıman Keçesi Değişimi Süreci
...
### 2. Keçe Tipi Belirleme

- Kaçak kaynağı tespiti (çıkış mili, giriş mili, diferansiyel)
- Keçe tipi ve boyut belirleme
- Orijinal veya onaylı keçe seçimi

### 3. Şanzıman Söküm (Gerekirse)

- Şanzıman sökümü (keçe değişimi için)
- Erişim sağlanması
...
- Eski keçe sökümü
- Keçe yatağı temizliği
- Yeni keçe montajı (doğru yön ve pozisyon)
...
## Keçe Değişimi Sonrası Garanti

- **Çıkış mili keçesi:** 12 ay / 20.000 km garanti
- **Giriş mili keçesi:** 12 ay / 20.000 km garanti
- **Diferansiyel keçesi:** 12 ay / 20.000 km garanti
- **Mekatronik modül keçesi:** 12 ay / 20.000 km garanti

## Keçe Değişimi Ne Zaman Gerekir?

### Belirtiler

- **Yağ lekesi:** Şanzıman altında veya çıkış mili çevresinde yağ lekesi
- **Yağ seviyesi düşüşü:** Periyodik kontrolde yağ seviyesi sürekli düşüyor
- **Koku:** Yanık yağ kokusu (aşırı ısınma belirtisi)
- **Gürültü:** Çıkış mili çevresinde sürtünme sesi
- **Performans kaybı:** Vites geçişlerinde gecikme veya sertlik

### Periyot

- **Normal kullanım:** 100.000–150.000 km
...
- **15+ Yıl Deneyim:** Şanzıman keçe değişiminde uzman ekip
...
- **Garanti:** Tüm keçe değişimlerinde 12 ay / 20.000 km garanti
- **Orijinal Parça:** Orijinal veya onaylı keçe kullanımı

## Keçe Değişimi vs. Komple Şanzıman Değişimi
...
Keçe değişimi, erken teşhis durumunda şanzıman değişiminden %95 daha ekonomiktir. Yağ kaçağı belirtileri görüldüğünde hemen müdahale edilmelidir.

:::

## Sık Sorulan Sorular

### Şanzıman keçesi değişimi ne kadar sürer?

Basit çıkış mili keçesi değişimi 2-3 saat, giriş mili keçesi değişimi 3-4 saat, diferansiyel keçesi değişimi 4-6 saat sürer. Şanzıman sökümü gerekiyorsa süre artar.
...
Çıkış mili keçesi değişimi genellikle şanzıman sökümü gerektirmez. Giriş mili ve diferansiyel keçesi değişimi için şanzıman sökümü gerekebilir.

### Orijinal keçe mi yoksa aftermarket keçe mi kullanılmalı?

Orijinal keçe kullanımı daha pahalıdır ancak uzun ömürlüdür. Onaylı aftermarket keçeler de güvenilirdir ve daha ekonomiktir. Uzman tavsiyesi alınmalıdır.

### Keçe değişimi sonrası yağ değişimi gerekir mi?

Keçe değişimi sırasında yağ kaybı olmuşsa yağ seviyesi ayarlanır. Yağ kalitesi düşükse yağ değişimi önerilir.
