...
# Hizmet Şeması
serviceName: "Fren Balata Değişimi"
...
Yıldızlar Grup, tüm premium markalarda şeffaf ve uygun fiyatlı balata değişimi işçilik hizmeti sunmaktadır. Audi, BMW, Mercedes, Volkswagen, Porsche, Land Rover, Seat, Skoda modellerinde yetkili servise göre %30-50 daha ekonomik işçilik ücretleriyle hizmet veriyoruz.

Balata değişimi işçilik ücreti, aracın markası, modeli, fren sistemi tipi ve işlem süresine göre değişir. Seramik fren sistemli araçlarda işçilik daha yüksektir. Disk taşlama veya değişimi gerekirse ek ücret uygulanır.

:::tip

**UZMAN TAVSİYESİ:** Balata değişiminde sadece işçilik değil, toplam maliyet önemlidir. Yetkili servisler yüksek işçilik + pahalı parça ile %100-150 fazla ücret alır. Özel servislerde kaliteli muadil parça + uygun işçilik ile %40-60 tasarruf sağlanır. Disk kontrolü mutlaka yapılmalı, gerekirse taşlanmalıdır.
...
### Marka Bazlı İşçilik Ücretleri

#### Audi Balata Değişim İşçilik Ücreti
...
**Standart Fren Sistemi:**
- En yaygın tip
- Normal işçilik ücreti
- Standart ekipman yeterli

**Seramik Fren Sistemi:**
...
- Bilgisayar bağlantısı gerekli
- +200-400₺ ek işçilik

### 2. Araç Modeli ve Yılı

**Yeni Model Araçlar:**
- Daha karmaşık fren sistemi
...
- Basit fren sistemi
- Hızlı işlem
- Daha ekonomik işçilik

### 3. Disk Durumu

**Disk İyi Durumda:**
- Sadece balata değişimi
- Standart işçilik

**Disk Taşlama Gerekli:**
- +400-600₺ ek işçilik
- +30-60 dk ek süre

**Disk Değişimi Gerekli:**
- +500-800₺ ek işçilik (takoz başı)
- +1-2 saat ek süre
...
## Yetkili Servis vs Özel Servis İşçilik Karşılaştırması

### Yetkili Servis İşçilik Ücretleri
...
## Balata Değişimi İşlem Süresi

| İşlem | Süre | Açıklama |
| --- | --- | --- |
| Sadece ön balata | 1-1.5 saat | Disk kontrolü dahil |
| Sadece arka balata | 1-1.5 saat | Disk kontrolü dahil |
| Ön + arka balata | 2-3 saat | Tüm sistem kontrolü |
| Balata + disk taşlama | 2.5-3.5 saat | Disk yüzey düzeltme |
| Balata + disk değişimi | 3-4 saat | Disk sökme-takma |
| Seramik fren balata | 2.5-3.5 saat | Özel dikkat gerekli |

## Balata Değişiminde Yapılan İşlemler

### Standart Balata Değişimi Prosedürü

1. **Araç Kaldırma:** Araç lift veya kriko ile kaldırılır
2. **Tekerlek Sökme:** İlgili tekerlek sökülür
3. **Kaliper Sökme:** Fren kaliper pistonları geri itilir, kaliper sökülür
4. **Eski Balata Çıkarma:** Aşınmış balatalar çıkarılır
5. **Disk Kontrolü:** Disk kalınlığı ve yüzey durumu kontrol edilir
6. **Disk Temizliği/Taşlama:** Gerekirse disk taşlanır
7. **Yeni Balata Takma:** Yeni balatalar takılır
8. **Kaliper Takma:** Kaliper yerine takılır, cıvatalar sıkılır
9. **Tekerlek Takma:** Tekerlek takılır, somunlar sıkılır
10. **Test:** Fren pedalı test edilir, sistem kontrol edilir

### Ek Kontroller (Dahil)

:::note

- Disk kalınlığı ölçümü
- Disk yüzey kontrolü
- Kaliper piston kontrolü
- Fren hidroliği seviye kontrolü
- Fren hortumu görsel kontrolü
- ABS sensörü kontrolü
- El freni kontrolü (arka balatada)
...
<div class="review-card">
  ...
  <div class="review-content">
    ...
    <p class="review-text">Polo aracımın frenlerinde sorun vardı iki üç yere götürmeme rağmen bu fren normal deyip gönderdiler ta ki yıldızlar a gelene kadar. Ustaları işinin ehli sizi dinliyor ve bilgilendiriyorlar. Bir saat gibi bi sürede sorunu çözüp yaptılar çok da memnun kaldık.</p>
  </div>
</div>
...
Balata değişimi 1-3 saat sürer. Sadece ön veya arka balata 1-1.5 saat, hem ön hem arka 2-3 saat sürer. Disk taşlama gerekirse +30-60 dakika eklenir.
...
Disk kalınlığı yeterli ve yüzey düzse değiştirilmesine gerek yoktur. Disk taşlama genellikle yeterlidir (400-600₺). Disk aşırı aşınmış veya çatlamışsa değiştirilmelidir.
...
Balata değişiminde disk kalınlığı, disk yüzeyi, kaliper pistonları, fren hidroliği, fren hortumları, ABS sensörleri ve el freni kontrol edilir. Tüm kontroller işçilik ücretine dahildir.
