...
**UZMAN TAVSİYESİ:** 7 ileri DSG şanzıman yağı her 60.000 km'de değiştirilmelidir. Düzenli yağ değişimi, şanzıman ömrünü %50 uzatır ve mekatronik arızasını %70 önler.
...
## 7 İleri DSG Şanzıman Yağı Nedir?

7 ileri DSG şanzıman yağı, şanzımanın çalışması için gerekli özel yağdır. Bu yağ:

- **Hidrolik basınç sağlar:** Mekatronik modül ve solenoid valfler için
- **Soğutma yapar:** Şanzıman sıcaklığını kontrol eder
- **Aşınmayı önler:** Metal yüzeyler arasında koruma sağlar
- **Performansı artırır:** Vites geçişlerini yumuşatır

7 ileri DSG şanzımanlarda kullanılan yağ tipleri:
...
- Fiyatlar şanzıman tipi, yağ markası ve işlem kapsamına göre değişir
- Filtre değişimi, yağ değişimi ile birlikte önerilir
- Adaptasyon, yağ değişimi sonrası önerilir
...
### DQ380/DQ381 (7 İleri Islak Kavrama)
...
- **Normal kullanım:** Her 60.000 km veya 3 yılda bir
- **Ağır kullanım:** Her 40.000 km veya 2 yılda bir
- **Şehir içi yoğun kullanım:** Her 50.000 km veya 2.5 yılda bir

### Erken Değişim Gerektiren Durumlar

- **Yağ kalitesi bozulması:** Renk değişimi, koku
- **Performans kaybı:** Vites geçiş sorunları
- **Arıza belirtileri:** Mekatronik sorunları
- **Su girişi:** Yağda su tespiti

## 7 İleri DSG Şanzıman Yağ Değişimi Süreci

### 1. Ön Kontrol

- Yağ seviyesi kontrolü
- Yağ kalitesi kontrolü
- Sıcaklık kontrolü
- Arıza kodları okuma
...
- Yeni yağın doldurulması
- Yağ filtresinin takılması
- Seviye kontrolü

### 4. Adaptasyon ve Test

- Adaptasyon/kalibrasyon
- Test sürüşü
- Final kontrolü

## Yağ Değişimi vs Filtre Değişimi

### Sadece Yağ Değişimi

**Ne Zaman:**
- Filtre yeni değiştirilmiş
- Bütçe kısıtlı
- Erken periyot
...
### 7 ileri DSG şanzıman yağ değişimi ne kadar sürer?

Yağ değişimi genellikle 1-2 saat sürer. Filtre değişimi ve adaptasyon dahil 2-3 saat sürebilir.

### 7 ileri DSG şanzıman yağ değişimi sonrası adaptasyon gerekir mi?

Evet, yağ değişimi sonrası adaptasyon önerilir. Bu işlem performansı artırır ve sorunları önler.

### 7 ileri DSG şanzıman yağ değişimi garanti kapsamında mı?
